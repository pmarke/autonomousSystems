...
log_K= fopen("/tmp/AS_UKF/k.log","r");
log_t= fopen("/tmp/AS_UKF/t.log","r");
log_x= fopen("/tmp/AS_UKF/x.log","r");
log_xh= fopen("/tmp/AS_UKF/xh.log","r");
log_u= fopen("/tmp/AS_UKF/u.log","r");
log_P= fopen("/tmp/AS_UKF/P.log","r");
log_m= fopen("/tmp/AS_UKF/m.log","r");
...
for i = 1:animation_dec:length(m_array)
    ...
    animate(t_array(i),x_array(:,i),xh_array(:,i),num_meas,m_pos,m_array(:,:,i))
    pause(0.5)
